...
try
{
    ...
    builder.Services.AddSerilog((services, lc) => lc
        ...
        .WriteTo.Seq(builder.Configuration["Seq:ServerUrl"] ?? "http://localhost:5341")); // configure SEQ_URL in ~/.claude/kit.config.md
...
| Log storage (development) | Seq (default — configure SEQ_URL in kit.config.md) |
