...
2. If user approves:
   - Classify using memory_classify
   - Add to memory store via memory_store with source: "promoted-instinct"
   - Remove from .claude/instincts.md
   - Format as a clear, generalized rule
...
| Instinct at 0.9 | Present evidence to user, offer promotion to memory store |
