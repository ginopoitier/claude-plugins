...
export function registerExportTools(server: McpServer, storage: StorageService): void {
  server.tool(
    "memory_export",
    "Export all memories for a project as a single Markdown document or JSON array, with optional type filtering.",
    ExportInputSchema,
    async (params) => {
      try {
