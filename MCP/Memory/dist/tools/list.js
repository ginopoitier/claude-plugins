...
function sortMemories(memories, sortField) {
...
export function registerListTools(server, storage) {
    server.tool("memory_list", "List all memories for a project, with optional type filtering and sorting. Summary format omits body content.", ListInputSchema, async (params) => {
        try {
