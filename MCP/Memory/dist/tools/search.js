...
export function registerSearchTools(server, storage) {
    server.tool("memory_search", "Search memories using TF-IDF semantic scoring. Returns ranked results filtered by type and minimum score.", SearchInputSchema, async (params) => {
        try {
