...
## Available Agents
- `code-reviewer` — review a PR or set of changes for correctness, patterns, architecture
- `build-error-resolver` — diagnose and fix compilation errors
- `security-auditor` — scan for vulnerabilities and security antipatterns
- `performance-analyst` — profile bottlenecks and recommend optimizations
- `devops-engineer` — CI/CD, Docker, deployment, infrastructure tasks
- `refactor-cleaner` — clean up technical debt, extract methods, rename for clarity
