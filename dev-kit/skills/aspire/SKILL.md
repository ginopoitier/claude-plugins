...
user-invocable: true
argument-hint: "[project or service to configure]"
...
// Don't deploy the AppHost to Kubernetes
...
```csharp
// BAD — hardcoding defeats Aspire's purpose
...
| Single-project local dev | `dotnet run` is fine |
