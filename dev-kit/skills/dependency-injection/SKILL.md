...
description: >
  Dependency injection patterns for .NET. Covers service lifetimes, keyed
...
user-invocable: true
argument-hint: "[service or interface to register]"
...
public class OrderService(IServiceProvider serviceProvider)
{
    ...
    {
        var db = serviceProvider.GetRequiredService<AppDbContext>(); // don't do this
    }
}

// GOOD — inject what you need directly
